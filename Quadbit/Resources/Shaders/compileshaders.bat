...
glslangValidator.exe	 -V imgui_vert.glsl			-S vert		-o Compiled/imgui_vert.spv
...
glslangValidator.exe	 -V waveheights.comp.glsl	-S comp		-o Compiled/waveheights.comp.spv