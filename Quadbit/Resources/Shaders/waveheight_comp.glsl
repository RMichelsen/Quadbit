...
layout(binding = 1, rgba8) readonly uniform image2D h0tilde;
layout(binding = 2, rgba8) readonly uniform image2D h0tilde_conj;
layout(binding = 3, rgba8) writeonly uniform image2D h0tilde_tx;
layout(binding = 4, rgba8) writeonly uniform image2D h0tilde_ty;
layout(binding = 5, rgba8) writeonly uniform image2D h0tilde_tz;
