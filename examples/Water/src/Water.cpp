...
void Water::Init() {
	...
	// Create UBO
	renderer_->CreateGPUBuffer(togglesUBO_, sizeof(TogglesUBO), VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT, Quadbit::QbVkMemoryUsage::QBVK_MEMORY_USAGE_CPU_TO_GPU);
...
void Water::InitPrecalcComputeInstance() {
	// Create UBO
	renderer_->CreateGPUBuffer(precalcResources_.ubo, sizeof(PrecalcUBO), VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT, Quadbit::QbVkMemoryUsage::QBVK_MEMORY_USAGE_CPU_TO_GPU);
	...
	renderer_->CreateGPUBuffer(precalcResources_.uniformRandomsStorageBuffer, uniformRandomsSize, VK_BUFFER_USAGE_STORAGE_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT, 
...
void Water::InitWaveheightComputeInstance() {
	// Create UBO
	renderer_->CreateGPUBuffer(waveheightResources_.ubo, sizeof(WaveheightUBO), VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT, Quadbit::QbVkMemoryUsage::QBVK_MEMORY_USAGE_CPU_TO_GPU);
